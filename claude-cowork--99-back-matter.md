...
**Nik Bear Brown** is an Associate Teaching Professor at Northeastern University and founder of Humanitarians AI Incorporated, a 501(c)(3) nonprofit bridge education program based in Boston. He is the primary architect of the Irreducibly Human and AI+1 textbook frameworks. This book is published by **Bear Brown LLC**; it was developed through the Humanitarians AI curriculum pipeline, which connects international graduates on Optional Practical Training with real projects, experienced mentors, and a curriculum built around judgment, causal reasoning, and disciplined use of powerful tools.
