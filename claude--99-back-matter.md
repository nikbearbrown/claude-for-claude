...
**Nik Bear Brown** is an Associate Teaching Professor at Northeastern University and the founder and primary architect of the Irreducibly Human and AI+1 textbook frameworks. This book is published by **Bear Brown LLC**. Nik's work on AI literacy and practitioner workflows has been developed and refined through Humanitarians AI Incorporated, a 501(c)(3) nonprofit bridge education program that connects international graduates on Optional Practical Training with real projects, mentors, and a curriculum built around judgment and disciplined use of powerful tools.
